window.onload = function () {
	...
	if (filters.length) { // có filter
		...
		addKhungSanPham('SẢN PHẨM ĐÁNH GIÁ NHIỀU',blue, ['star=3', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('SẢN PHẨM MỚI RA MẮT', blue, ['promo=moiramat', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('TRẢ GÓP', blue, ['promo=tragop', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('GIÁ SỐC ONLINE', blue, ['promo=giareonline', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('GIẢM GIÁ LỚN', blue, ['promo=giamgia'], soLuong, div);
		addKhungSanPham('GIÁ RẺ CHO MỌI NHÀ', blue, ['price=0-3000000', 'sort=price'], soLuong, div);
	}
