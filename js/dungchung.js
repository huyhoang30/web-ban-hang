...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Huy Hoang Store</a> - All rights reserved © 2024
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                ...
                <li>Lỗi đổi tại cửa hàng trong 3 ngày</li>
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Hotline:
                    <a href="tel:0866020902" style="color: #288ad6;">0866020902</a>
                </li>
            </ul>
        </section>
    </div>`);
